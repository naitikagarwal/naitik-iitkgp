  ...
  const events = [
    {
      ...
      description:
        "Contributed to campus welfare initiatives as an Associate Member of the SWG at IIT Kharagpur (Sep 2024 – May 2025).",
    },
    {
      year: "2024",
      title: "Campus Affiliate - Kshitij, IIT Kharagpur",
      description:
        "Joined Kshitij as a Campus Affiliate (Oct 2024 – June 2025), actively engaged in event management and campus outreach.",
    },
    {
      year: "2024",
      title: "Trainee Developer - KodeinKGP",
      description:
        "Worked as a Trainee Developer (Nov 2024 – May 2025), focusing on React.js and Machine Learning projects.",
    },
    {
      year: "2025",
      title: "Senior Executive Member - KodeinKGP",
      description:
        "Promoted to Senior Executive Member at KodeinKGP (May 2025 – Present), leading development and mentoring responsibilities.",
    },
  ];
