...
export const Projects = () => {
  const projects = [
    {
  "title": "Jister",
  "description": "An IIT JEE practice platform with smart analytics, peer competition, and a vast question bank for effective preparation.",
  ...
  {
    "title": "Note App",
    "description": "A full-featured note-taking app built with React, TypeScript, and localStorage support for persistence.",
  ...
  {
    "title": "Weather App",
    "description": "A clean and responsive weather forecasting app using React and Weather API, deployed via Netlify.",
