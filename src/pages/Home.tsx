...
export const Home = () => {
    ...
    useEffect(() => {
        fetch(
            "https://codeforces.com/api/user.info?handles=naitikagarwal"
        )
            .then((res) => res.json())
            .then((data) => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-20" style={{ fontFamily: "Kalam" }}>
            {/* Hero Section */}
            <motion.div
            ...
            >
                ...
                <div className="flex justify-center gap-4">
                    <a href="https://github.com/naitikagarwal" target="_blank" rel="noopener noreferrer">
                        <Github className="w-6 h-6 hover:text-purple-600 transition-colors" />
                    </a>
                    <a href="https://codeforces.com/profile/naitikagarwal" target="_blank" rel="noopener noreferrer">
                        <SiCodeforces className="w-6 h-6 hover:text-[#1F8ACB] transition-colors duration-200" />
                    </a>
                    <a href="https://linkedin.com/in/naitik-kr-agarwal" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://instagram.com/naitik_agarwal__" target="_blank" rel="noopener noreferrer">
            ...
            >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div>
                        <p className="mb-4 text-gray-700 dark:text-gray-300"> I am a second‑year BTech student at IIT Kharagpur with a strong passion for technology and software development. Despite my core discipline in Bioscience and Biotechnology, I have immersed myself in coding projects, continuously   sharpening my problem‑solving skills.
                        </p>
                        <p className="mb-4 text-gray-700 dark:text-gray-300">
                            I have a Codeforces rating of {" "}{rating !== null ? rating : "1300"}<a href='https://codeforces.com/profile/naitikagarwal' target='_blank'><ExternalLink className="inline w-4 h-4 text-blue-600 align-text-top" /></a>, reflecting my dedication to data structures & algorithms, and I’ve built web applications using React and Node.js while exploring AI/ML projects in Python.
                        </p>
                    ...
                    <div className="flex flex-col gap-4">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {['Python', 'JavaScript', 'React', 'Node.js', 'TensorFlow', 'C++', 'Tailwind', 'TypeScript'].map(skill => (
                                    <span
                                        key={skill}
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {['DSA', 'Web Dev', 'AI/ML', 'Open Source', 'Competitive Programming'].map(interest => (
                                    <span
                                        key={interest}
